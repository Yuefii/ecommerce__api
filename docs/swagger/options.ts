...
import { loginUser, createUser, getAllUsers, getUserById } from './paths/users'
import {
  createDiscus,
  deleteDiscus,
  createReplyDiscus,
...
export const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description:
        'I created this api to collaborate with my friend in building an ecommerce website project.',
      contact: {
        name: 'yuefii',
